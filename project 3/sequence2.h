// Provided by:   ____________(Jacky Liu)__________
// Email Address: ____________(yliu009@citymail.cuny.edu)________
// FILE: sequence2.h
...
//     sequence(const sequence& source)
        ...
        // copy constructor
//      postcondition- everything in the source sequence is copied to the object calling the copy constructor.
//
...
namespace main_savitch_4
{
    ...
    public:
        ...
        bool is_item( ) const;
        value_type current( ) const;
        value_type operator [] (size_type index) const; // overloading the subscript operator
    ...
    private:
        ...
        size_type current_index; // the current index of the array
